...
try:
    from app.core.model_backends import GenerationConfig, LoadingResult, HardwareInfo
...
class GGUFModel:
    ...
    def extract_metadata(self) -> bool:
        ...
        try:
            ...
            from app.core.model_metadata_extractor import ModelMetadataExtractor, GGUFParseError
