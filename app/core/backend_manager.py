...
class BackendManager:
    ...
    def _ensure_backends_registered(self):
        ...
        try:
            ...
            from app.backends.ctransformers_backend import CtransformersBackend
            from app.backends.transformers_backend import TransformersBackend
            from app.backends.llamafile_backend import LlamafileBackend
            from app.backends.llama_cpp_python_backend import LlamaCppPythonBackend
