...
from app.core.error_manager import ErrorManager
from app.core.recovery_manager import RecoveryManager
from app.core.model_service import ModelService
from app.ui.main_window import MainWindow

from utils.error_handling import ErrorCategory, ErrorSeverity, setup_logging
from utils.exceptions import GGUFLoaderError
...
class ApplicationController:
    ...
    def __init__(self, startup_options: Optional[Dict[str, Any]] = None):
        ...
        log_dir = Path.home() / ".gguf-loader" / "logs"
        self.root_logger = setup_logging(str(log_dir))
        
        self.logger = logging.getLogger("gguf_loader.controller")
        ...
        config_dir = Path.home() / ".gguf-loader"
