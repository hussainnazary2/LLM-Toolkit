...
class HuggingFaceIntegration:
    ...
    def __init__(self, cache_dir: Optional[str] = None):
        ...
        # Check availability
        if not HF_AVAILABLE:
            self.logger.error(f"Hugging Face libraries not available: {HF_IMPORT_ERROR}")
            raise ImportError(f"Required Hugging Face libraries not installed: {HF_IMPORT_ERROR}")
