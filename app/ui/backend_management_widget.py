...
from app.core.monitoring import monitoring_manager, SystemMetrics, PerformanceMetrics
from app.ui.mixins.theme_mixin import DialogThemeMixin
...
class GPUUtilizationWidget(QWidget):
    ...
    def _create_gpu_card(self, gpu_info: Dict[str, Any]) -> QWidget:
        ...
        if 'power_usage_w' in gpu_info and gpu_info['power_usage_w'] > 0:
            power_label = QLabel(f"⚡ {gpu_info['power_usage_w']:.1f}W")
