...
from app.ui.backend_management_widget import BackendManagementWidget
...
class ModelSettingsWidget(QWidget):
    ...
    def _initialize_gpu_detection(self):
        """Initialize GPU detection."""
        try:
            from app.core.gpu_acceleration import GPUAcceleration
    ...
    def _update_device_combo(self):
        ...
        from app.core.gpu_detector import GPUBackend
        try:
    ...
    def _on_install_gpu_support(self):
        ...
        from app.ui.gpu_installation_dialog import GPUInstallationDialog
